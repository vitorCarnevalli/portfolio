          ...
          >
            ...
            <motion.div variants={fadeUp} className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 w-full sm:w-auto bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl text-sm font-bold shadow-lg hover:-translate-y-0.5 hover:shadow-xl transition-all duration-200"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 w-full sm:w-auto bg-[#0077b5] text-white rounded-2xl text-sm font-bold shadow-lg hover:-translate-y-0.5 hover:shadow-xl transition-all duration-200"
              >
              ...
              <a
                href="/curriculo.pdf"
                download
                className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 w-full sm:w-auto glass text-slate-700 dark:text-slate-300 rounded-2xl text-sm font-bold hover:-translate-y-0.5 transition-all duration-200"
              >
