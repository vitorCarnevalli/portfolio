          ...
          >
            ...
            <motion.div variants={slideRight} className="flex flex-col sm:flex-row gap-3">
              <MagneticButton
                ...
                className="shimmer inline-flex items-center justify-center gap-2.5 px-7 py-3.5 w-full sm:w-auto bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-2xl text-sm font-bold shadow-xl shadow-slate-900/20 dark:shadow-white/10"
              >
              ...
              <MagneticButton
                ...
                className="shimmer inline-flex items-center justify-center gap-2.5 px-7 py-3.5 w-full sm:w-auto bg-[#0077b5] text-white rounded-2xl text-sm font-bold shadow-xl shadow-[#0077b5]/20"
              >
              ...
              <MagneticButton
                href="/curriculo.pdf"
                download
                className="inline-flex items-center justify-center gap-2.5 px-7 py-3.5 w-full sm:w-auto glass text-slate-700 dark:text-slate-300 rounded-2xl text-sm font-bold"
              >
